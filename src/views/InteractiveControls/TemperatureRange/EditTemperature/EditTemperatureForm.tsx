...
interface IEditTemperatureForm {
...
const EditTemperatureForm: React.FC<IEditTemperatureForm> = ({ useFormReturn, onSubmit, clients, loadingState }) => {
  return (
    <Row>
      <Col md={{ span: 6, offset: 1 }}>
        <Form useFormReturn={useFormReturn} onSubmit={onSubmit}>
          <Row>
            ...
            <Col xl={6} lg={6} md={6} sm={12}>
              <Form.Input label="Min Temperature" name="min" placeholder="Enter min temperature" />
            </Col>
            <Col xl={6} lg={6} md={6} sm={12}>
...
export default EditTemperatureForm;
